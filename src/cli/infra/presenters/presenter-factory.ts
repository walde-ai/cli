...
import { FormatPresenterV1 } from './format-presenter-v1';
...
export class PresenterFactory {
  ...
  /**
   * Create format presenter
   */
  public static createFormatPresenter(): IFormatPresenter {
    const spinner = new DefaultSpinnerComponent();
    const prompt = new DefaultPromptComponent();
    const config = DefaultPresenterConfig;

    return new FormatPresenterV1(spinner, prompt, config);
  }
